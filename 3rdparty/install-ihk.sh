...
cd $BUILDDIR
cmake -DENABLE_PERF=OFF -DCMAKE_INSTALL_RPATH="${INSTALLDIR}/lib/" -DFIND_LIBRARY_USE_LIB64_PATHS=TRUE -DCMAKE_INSTALL_PREFIX=${INSTALLDIR} -DCMAKE_CXXFLAGS='-DDEBUG_PRINT' ${IHKDIR}

...
Ausführung selbst beeinflusst werden würde. \todo{Wo liegt dieses Werkzeug und wie
Verwendet man es? Oder darauf verweisen, dass es gerade an die neue
Kernel-Architektur angepasst wird?} Das Tracing Werkzeug wird momentan erweitert
